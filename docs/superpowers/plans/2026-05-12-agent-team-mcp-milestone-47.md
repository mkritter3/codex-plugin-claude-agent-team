...
- [x] **Step 2: Add failing live matrix script tests**
...
- [x] **Step 1: Connect through packaged MCP stdio**
...
- [x] **Step 4: Add isolated implementation proof**
...
- [x] **Step 5: Add mailbox, wind-down, and cancel proofs**
...
- [x] **Step 6: Add team records and dashboard/summary proof**
